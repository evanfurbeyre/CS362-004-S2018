...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case feast:
        feastEffect(choice1, choice2, currentPlayer, state, temphand);
		return 0;
	...
	case mine:
        mineEffect(choice1, choice2, handPos, currentPlayer, state);
        return 0;
...
int adventurerEffect(int drawntreasure, int currentPlayer, struct gameState *state, int *temphand, int z)
{
    int cardDrawn;
